"""RankNet pairwise ranking, i.e. Bradley-Terry: P(i beats j) = σ(s_i - s_j).

also holds the delta-weighted variants from the bets: large_delta upweights big
|Δy| pairs, small_delta does the opposite. small_delta transfers better to CAGI5.
"""
