"""differentiable sorting so you can backprop through ranks.

wants torchsort (https://github.com/teddykoker/torchsort); falls back to a
sigmoid soft-rank if it is not installed.
"""
